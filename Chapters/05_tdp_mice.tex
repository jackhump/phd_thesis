...
Work presented in this chapter has been published as part of \citep{Fratta2018}
...
\begin{itemize}
	\item All RT-PCRs presented were performed, quantified and plotted by Pietro Fratta and Prasanth Sivakumar
	\item All RNA-seq and iCLIP sequencing libraries were created by Prasanth Sivakumar, Agnieszka Ule and Pietro Fratta (???)
	\item Mice were handled by Thomas Ricketts and Cristian Bodo
	\item Preliminary analysis of splicing was performed by Warren Emmett and Kitty Lo
	\item I processed all RNA-seq data and performed all the splicing analyses bar Figures \ref{fig:mef_scatters} and \ref{fig:cassette_scatters} which were performed and visualised by Kitty Lo and Prasanth Sivakumar respectively
\end{itemize}
