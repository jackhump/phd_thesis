...
\section{Amyotrophic Lateral Sclerosis and Frontotemporal Dementia form a spectrum of disease} % the disease problem
...
\begin{figure}[h!]
	...
	\caption{\textbf{Protein domains of TDP-43 and FUS} }
	Structures of the two proteins, coloured by functional domain. Positions of each mutation are represented by black bars. Figure adapted from \citep{Kapeli2017}. 
...
Although causative ALS mutations have been found throughout the FUS protein, mutations with the lowest age of onset and shortest disease course are clustered in the proline-tyrosine) nuclear localisation signal (NLS). 
