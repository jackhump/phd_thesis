...
\begin{figure}[ht!]
	...
	\caption[Xlr genes are upregulated in both FUS KO and FUS MUT in mice of both sexes]{
    	...
    	Normalised read counts in each dataset, plotted relative to the mean of each dataset and condition-specific control group for Xlr3a \textbf{(A)} and Xlr3b \textbf{(B)}. 
	}
